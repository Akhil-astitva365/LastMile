package com.deliverytracker.common;
...
public class ErrorResponse {
    ...
    public ErrorResponse(int status, String error, String message, String path, Map<String, String> validationErrors, LocalDateTime timestamp) {
        this.status = status;
        this.error = error;
