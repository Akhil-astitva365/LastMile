      ...
      <div>
        ...
        <div className="my-4 flex items-center justify-between gap-3 bg-slate-950/50 p-3 rounded-xl border border-slate-900">
          <div className="flex-1 min-w-0">
            ...
            <p className="text-xs text-slate-200 font-medium truncate flex items-center gap-1" title={order.pickupAddress}>
          ...
          <div className="flex-1 text-right min-w-0">
            ...
            <p className="text-xs text-slate-200 font-medium truncate flex items-center gap-1 justify-end" title={order.dropAddress}>
        ...
        {order.assignedAgentName && (
          <div className="mt-3 text-xs text-slate-400 flex items-center gap-1">
            ...
            Agent: <span className="text-slate-200 font-semibold truncate">{order.assignedAgentName}</span>
          </div>
        )}
      </div>
